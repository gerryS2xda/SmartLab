...
<html>
	...
	<section id="main_content">
		...
		<div id="box_form">
			<form name="reg_form" action="../ServletUtente" method="post">
				<fieldset>
				...
				<fieldset>
					...
					<div class="input_field">	
						...
						<input id="email" type="email" name="u_email" value="" onfocus="addActive('lbl2')" onblur="validateEmail('email', 'lbl2', 'mail_err')">
						&nbsp;&nbsp;
					</div>
					<p id="mail_err" class="txt_error"> </p> <br>
					<div class="input_field">	
						<label id="lbl3" for="pwd" class="">Password</label>
						<input id="pwd" type="text" name="pwd" value="" onfocus="addActive('lbl3')" onblur="validatePassword('pwd', 'lbl3', 'pwd_err')">
						&nbsp;&nbsp;
					</div>
